      ...
      '/src/iOS/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Swift Package Manager下载缓慢解决方案', link: '/src/iOS/Swift/Swift Package Manager下载缓慢解决方案' },
      ...
      '/src/Mac OSX/': [
        {
          ...
          items: [
            { text: 'Shell执行sudo命令时，自动输入密码', link: '/src/Mac OSX/macOS/Shell执行sudo命令时，自动输入密码' },
            { text: 'Github创建SSH：Sourcetree自动创建与手动创建', link: '/src/Mac OSX/macOS/Github创建SSH：Sourcetree自动创建与手动创建' },
            { text: 'Github多帐号解决方案', link: '/src/Mac OSX/macOS/Github多帐号解决方案' },
            { text: 'Github通过Hosts文件解决访问问题', link: '/src/Mac OSX/macOS/Github通过Hosts文件解决访问问题' },
            { text: 'Apache配置https', link: '/src/Mac OSX/macOS/Apache配置https' },
            { text: '使用networksetup命令手动设置IP地址', link: '/src/Mac OSX/macOS/使用 networksetup命令手动设置IP地址' },
            { text: 'macOS12编译Swift6的步骤与问题', link: '/src/Mac OSX/macOS/macOS12编译Swift6的步骤与问题' },
            { text: 'GitHub清空仓库冗余数据，只保留一份最新代码', link: '/src/Mac OSX/macOS/GitHub清空仓库冗余数据，只保留一份最新代码' },
          ]
        }
      ],
      '/src/Python/': [
        {
          ...
          items: [
            { text: '使用虚拟环境编译，运行Python源代码', link: '/src/Python/Python/1.使用虚拟环境编译，运行Python源代码' },
          ]
        }
      ],
      '/src/Linux/': [
        {
          ...
          items: [
            { text: 'Linux查看版本信息', link: '/src/Linux/Linux/Linux查看版本信息' },
            { text: 'Ubuntu中文支持,及中文乱码问题', link: '/src/Linux/Linux/Ubuntu中文支持,及中文乱码问题' },
            { text: 'Ubuntu sources.list软件源配置', link: '/src/Linux/Linux/Ubuntu sources.list软件源配置' },
            { text: 'Ubuntu自定义程序图标', link: '/src/Linux/Linux/Ubuntu自定义程序图标' },
            { text: 'Ubuntu22.04安装PostgreSQL 16 教程', link: '/src/Linux/Linux/Ubuntu22.04安装PostgreSQL 16 教程' },
      ...
      '/src/玩机/': [
        {
          ...
          items: [
            { text: 'Termux+macOS自定义端口记录', link: '/src/玩机/玩机/Termux+macOS自定义端口记录' },
            { text: 'Termux+Ubuntu+SSH+SFTP+Swift+Code-Server', link: '/src/玩机/玩机/Termux+Ubuntu+SSH+SFTP+Swift+Code-Server' },
            { text: 'Open-vm-tools工具的安装与使用', link: '/src/玩机/玩机/open-vm-tools工具的安装与使用' },
            { text: 'Anlinux-Resources Netlify 资源同步', link: '/src/玩机/玩机/Anlinux-Resources Netlify 资源同步' },
            { text: 'SideStore + LiveContainer 实现自签名与安装任意应用', link: '/src/玩机/玩机/SideStore + LiveContainer 实现自签名与安装任意应用' },
          ]
        }
      ],
      '/src/Netfity/': [
