...
<div class="grid-container">
  <a class="grid-item" :href="`${base}/src/iOS/Swift/Swift 中关于动态链接库设置问题`">Swift 中关于动态链接库设置问题</a>
  <a class="grid-item" :href="`${base}/src/iOS/Swift/Swift Package Manager下载缓慢解决方案`">Swift Package Manager下载缓慢解决方案</a>
