...
<span class="line"><span> headers[&quot;password&quot;]</span></span>
<span class="line"><span> **/</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/**</span></span>
<span class="line"><span>  功能：清空数据</span></span>
<span class="line"><span>  方式：DELETE</span></span>
<span class="line"><span>  API：/v1/backup/reset</span></span>
<span class="line"><span>  认证参数：</span></span>
<span class="line"><span>  headers[&quot;username&quot;]</span></span>
<span class="line"><span>  headers[&quot;password&quot;]</span></span>
<span class="line"><span>**/</span></span></code></pre></div><p>数据临时存储(存储在内存中的)：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/**</span></span>
<span class="line"><span> 功能：上传临时数据到内存</span></span>
<span class="line"><span> 方式：POST</span></span>
<span class="line"><span> API：/storage/memory/mapping</span></span>
<span class="line"><span> 路由参数：key</span></span>
<span class="line"><span> 示例：/storage/memory/mapping/[name]</span></span>
<span class="line"><span> **/</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/**</span></span>
<span class="line"><span> 功能：从临时数据中获取指定数据</span></span>
<span class="line"><span> 方式：GET</span></span>
<span class="line"><span> API：/storage/memory/mapping</span></span>
<span class="line"><span> 路由参数：key</span></span>
<span class="line"><span> 示例：/storage/memory/mapping/[name]</span></span>
<span class="line"><span> **/</span></span></code></pre></div><h2 id="关于cts-v3文件" tabindex="-1">关于cts-v3文件 <a class="header-anchor" href="#关于cts-v3文件" aria-label="Permalink to &quot;关于cts-v3文件&quot;">​</a></h2><p>cts-v3文件部署平台：</p><ul><li><strong>CTSServer</strong>：/v1/deploy/cts-v3</li><li><strong>Github</strong>：<a href="https://github.com/RANSAA/kidlucky" target="_blank" rel="noreferrer">https://github.com/RANSAA/kidlucky</a></li><li><strong>GitCode</strong>：<a href="https://gitcode.com/sayaDev/kidlucky" target="_blank" rel="noreferrer">https://gitcode.com/sayaDev/kidlucky</a></li><li><strong>Gitee</strong>：<a href="https://gitee.com/kidlucky/kidlucky" target="_blank" rel="noreferrer">https://gitee.com/kidlucky/kidlucky</a></li><li><strong>Netlify</strong>：<a href="https://kidlucky.netlify.app" target="_blank" rel="noreferrer">https://kidlucky.netlify.app</a></li><li><strong>Github.io</strong>：<a href="https://ransaa.github.io/kidlucky" target="_blank" rel="noreferrer">https://ransaa.github.io/kidlucky</a></li></ul>`,71)])])}const h=a(t,[["render",l]]);export{g as __pageData,h as default};
