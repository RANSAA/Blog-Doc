import{_ as n,c as a,o as p,ag as l}from"./chunks/framework.Bee44SUS.js";const r=JSON.parse('{"title":"使用虚拟环境编译，运行Python源代码","description":"","frontmatter":{},"headers":[],"relativePath":"src/Python/Python/1.使用虚拟环境编译，运行Python源代码.md","filePath":"src/Python/Python/1.使用虚拟环境编译，运行Python源代码.md","lastUpdated":1789061297000}'),e={name:"src/Python/Python/1.使用虚拟环境编译，运行Python源代码.md"};function t(i,s,c,o,h,d){return p(),a("div",null,[...s[0]||(s[0]=[l(`<h1 id="使用虚拟环境编译-运行python源代码" tabindex="-1">使用虚拟环境编译，运行Python源代码 <a class="header-anchor" href="#使用虚拟环境编译-运行python源代码" aria-label="Permalink to &quot;使用虚拟环境编译，运行Python源代码&quot;">​</a></h1><p>在使用Python项目时，一般会依赖很多外部的软件或者安装包。但是直接使用Python安装会污染系统安装的软件， 这时就需要虚拟环境来运行Python以隔绝对系统的污染以达到安全运行的目的。</p><h1 id="虚拟环境的使用" tabindex="-1">虚拟环境的使用 <a class="header-anchor" href="#虚拟环境的使用" aria-label="Permalink to &quot;虚拟环境的使用&quot;">​</a></h1><ol><li>创建并进入虚拟环境</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># 创建并进入虚拟环境</span></span>
